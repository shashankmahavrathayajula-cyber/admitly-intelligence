  ...
  return (
    <Document>
      <Page size="LETTER" style={styles.page} wrap>
        ...
        {/* PAGE 2 — Cross-School Comparison */}
        <View break>
          <Header generatedDate={generatedDate} />
        ...
        <View style={styles.table}>
            ...
            <View key={d.key} style={[styles.tableRow, { backgroundColor: rowIdx % 2 === 0 ? COLORS.white : COLORS.lightGray }]}>
              ...
              {evaluations.map((e, i) => {
                ...
                return (
                  ...
                  >
                    <Text style={{ color: scoreColor(v), fontFamily: 'Helvetica-Bold', fontSize: 9 }}>
                      {v.toFixed(1)}
                    </Text>
                    <View style={{ width: 50, height: 4, backgroundColor: '#e5e7eb', borderRadius: 2, marginTop: 3 }}>
                      <View
                        style={{
                          width: `${Math.max(0, Math.min(100, (v / 10) * 100))}%`,
                          height: 4,
          ...
          <View style={[styles.tableRow, { backgroundColor: DIMENSIONS.length % 2 === 0 ? COLORS.white : COLORS.lightGray }]}>
            ...
            {evaluations.map((e, i) => {
              const isLast = i === evaluations.length - 1;
              const v = Number(e.alignmentScore) || 0;
              return (
                <View
                  key={i}
                  style={[
        ...
        {/* PAGE 3 — Strategic Action Plan + Strengths to Protect */}
        <View break>
          <Header generatedDate={generatedDate} />
